...
* @details	    since: Rate_temperature*Time_temperature + Rate_pressure*Time_pressure< 1 second
* @author		Garson
* @date		    2020 ,12
* @version	    v1.0
*/
...
//#define SPL06_READ_MASK 0x80 // used for spi
//CFG_REG
...
#define SPL06_DEVADDR         0xEC //(0x76<<1)
